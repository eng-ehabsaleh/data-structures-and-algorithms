...
def test_trip_one():
    ...
    assert graph.busness_trip( [naboo, pandora]) == "False,$0"
...
def test_trip_two():
    ...
    graph.add_edge(manstropolis, arendelle, 42)
    graph.add_edge(manstropolis, metroville, 105)
    assert graph.busness_trip([pandora, arendelle, metroville]) == "True,$249"
...
def test_trip_three():
    ...
    graph.add_edge(manstropolis, arendelle, 42)
    graph.add_edge(manstropolis, metroville, 105)
    assert graph.busness_trip([pandora, metroville]) == "True,$82"
